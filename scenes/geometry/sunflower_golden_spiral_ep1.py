...
class SunflowerGoldenSpiralChinese(Scene):
    ...
    def show_mystery(self):
        ...
        question_line1 = Text("为什么向日葵的种子", font_size=42, color=WHITE)
        question_line2 = Text("会形成螺旋？", font_size=42, color=WHITE)
        question = VGroup(question_line1, question_line2).arrange(DOWN, buff=0.3)
    ...
    def show_fibonacci(self):
        ...
        # 展示在自然界中的应用
        nature_line1 = Text("花瓣数、树枝分叉、贝壳螺旋...", font_size=28, color=GREEN)
        nature_line2 = Text("大自然钟爱这个数列！", font_size=28, color=GREEN)
        nature_examples = VGroup(nature_line1, nature_line2).arrange(DOWN, buff=0.3)
        nature_examples.next_to(fib_text, DOWN, buff=1.5)
    ...
    def show_golden_angle(self):
        ...
        # 黄金比例说明
        golden_ratio_line1 = Text("黄金角 = 360° × (2 - φ)", font_size=24, color=YELLOW)
        golden_ratio_line2 = Text("φ = 1.618... (黄金比例)", font_size=24, color=YELLOW)
        golden_ratio_text = VGroup(golden_ratio_line1, golden_ratio_line2).arrange(DOWN, buff=0.2)
        golden_ratio_text.to_corner(DR)
        ...
        # 展示为什么这个角度特殊
        explanation_line1 = Text("这个角度能让新生长的种子", font_size=28, color=GREEN)
        explanation_line2 = Text("与已有种子的重叠最小", font_size=28, color=GREEN)
        explanation = VGroup(explanation_line1, explanation_line2).arrange(DOWN, buff=0.2)
        explanation.next_to(circle, DOWN, buff=0.8)
    ...
    def create_sunflower(self):
        ...
        # 显示斐波那契螺旋
        spiral_info_1 = Text("21条顺时针螺旋", font_size=24, color=RED)
        spiral_info_2 = Text("34条逆时针螺旋", font_size=24, color=BLUE)
        spiral_info_3 = Text("都是斐波那契数！", font_size=28, color=GREEN)
        spiral_info = VGroup(spiral_info_1, spiral_info_2, spiral_info_3).arrange(DOWN, buff=0.3)
        spiral_info.to_corner(UR)
